...
for i, t in enumerate(timestamp_array):
   ...
   if sample_end - sample_start == 160 and len(a) == 160:
      ...
      pass
   #print "The values being added are: ", a
   #print "The new values now are: ", A_abs[sample_start:sample_start + 2]  
   #print '\n'
sf.write('abs_1msec_' + filename + '.wav', np.asarray(A_abs), 16000,format='wav',subtype="PCM_16")           
